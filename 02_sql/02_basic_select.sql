...
select emp_id,
		emp_name, hire_date, salary, dept_name from emp;
...
where emp_name like '%&%%' escape '&';  -- escape '특수문자' 특수문자뒤에 %나 _ 는 조회할 값임을 표시.(like의 패턴문자가 아니라) */
...
select * from emp
where job = 'Developer' and salary < 52000;
